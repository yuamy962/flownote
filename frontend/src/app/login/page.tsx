          ...
          <div className="w-full max-w-sm">
            ...
            <div className="mt-6">
              ...
              <button
                ...
                className="w-full mt-4 py-3 border border-green-200 rounded-xl text-sm font-medium text-green-700 hover:bg-green-50 flex items-center justify-center gap-2 transition-colors"
              >
